...
<div class="content">
	<div class="container-fluid">
		...
		<!-- balance sheet -->
		<div class="crypt-withdraw-body bg-white mt-3 mr-3 mb-3" id="dash" style="border-radius: 4px" id = "balance_sheet">
			<div class="row">
				...
				<div class="col-md-12">
					<div class="tab-content" id="v-pills-zilliqua-btc-tabContent">
						...
						<div class="tab-pane fade" id="v-pills-zilliqua-btc-withdrawl" role="tabpanel" aria-labelledby="v-pills-zilliqua-btc-withdrawl-tab">
					  	...
					  	<div class="tab-pane show active" id="v-pills-zilliqua-btc-history" role="tabpanel" aria-labelledby="v-pills-zilliqua-btc-history-tab">
					  		<h4 class="crypt-down pb-3" style="font-size: 24px; font-weight: 400"><i class="la la-clock-o"></i>&nbsp; My Transaction History</h4>
